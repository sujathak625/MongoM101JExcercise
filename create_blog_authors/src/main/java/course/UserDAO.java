...
public class UserDAO {
	...
	public boolean addUser(String username, String password, String email) {
		...
		Document userDoc = new Document("username", username).append("password", passwordHash).append("_id", username);
	...
	public Document validateLogin(String username, String password) {
		...
		user = new Document();
		List<Document> users = usersCollection.find(eq("username", username)).into(new ArrayList<Document>());
		//System.out.println("Size : " + users.size());
		for (Document guest : users) {
			//System.out.println("Size : " + users.size());
			user = guest;
		}
		if (user == null) {
